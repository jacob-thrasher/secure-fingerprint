...
train_dataset = SOCOFing_Gen(data_root, gt_root, 'data/vae_train.csv', drop_difficulty=['Medium', 'Hard'], sample=1)
test_dataset = SOCOFing_Gen(data_root, gt_root, 'data/vae_test.csv', drop_difficulty=['Medium', 'Hard'], sample=1)
